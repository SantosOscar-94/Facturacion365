...
// Función para simular clic en el elemento con id 'switcher-modern'
function activarSwitcherModern() {
    document.querySelector('#switcher-modern').click();
    document.querySelector('#switcher-primary').click();
}

// Llamar a la función al cargar la página
window.onload = function () {
    activarSwitcherModern();
};
