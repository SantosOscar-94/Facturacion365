...
switch ($_GET["op"]) {
    ...
    case 'listar':
        ...
        while ($reg = $rspta->fetch_object()) {
            $data[] = array(
                "0" => '<button class="btn btn-icon btn-wave waves-effect waves-light btn-sm btn-success-light" onclick="mostrar(' . $reg->idempresa . ')"><i class="fa fa-pencil"></i></button>',
                // .
                ...
                "4" => $reg->telefono1,
                "5" => $reg->web,
                "6" => ($reg->logo == "") ? "<img src='../files/logo/simagen.png' height='50px' width='50px'>" :
                    "<img src='../files/logo/" . $reg->logo . "' height='50px' width='50px'>"
            );
        }
