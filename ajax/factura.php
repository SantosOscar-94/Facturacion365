...
switch ($_GET["op"]) {
    ...
    case 'envioautomatico':
        ...
        $rspta = $factura->listar($idempr, $idusuario);
        //Vamos a declarar un array
        $data = array();
        ...
        while ($reg = $rspta->fetch_object()) {
            ...
            $data[] = array(
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" onclick="preticket2(' . $reg->idfactura . ')">Ticket</a>
                        <a class="dropdown-item" onclick="prea4completo2(' . $reg->idfactura . ')">A4</a>
            ...
            ',
                ...
                "8" => ($reg->estado == '1') //si esta emitido se genera el xml
                    ? '<span style="color:#BA4A00;">' . $reg->DetalleSunat . '</span><i class="fa fa-spinner fa-spin fa-1x fa-fw"></i><span class="sr-only">Loading...</span>'
                    ...
                    : (($reg->estado == '4') ? '<span style="color:#239B56;">' . $reg->DetalleSunat . '</span>' //si esta firmado
                        ...
                        : (($reg->estado == '3') ? '<i class="fa fa-dot-circle-o" style="font-size: 14px; color:#E59866;"> <span>' . $reg->DetalleSunat . '</span></i> ' // si esta de baja
                            ...
                            : (($reg->estado == '0') ? '<span>' . $reg->DetalleSunat . '</span><br><small style="color:green;"><i style="color:green"class="fa fa-credit-card-alt"></i> Comprobante Afectado</small>' //si esta firmado
                                ...
                                : (($reg->estado == '5') ? '<div class="boleta-status"><span style="color:#0a58ca;">' . $reg->DetalleSunat . '</span><img style="margin-left:47px; margin:0 auto;" src="../public/images/aceptado.png" width="28px" height="28px" title="Estado de sunat aceptado"></div>' // Si esta aceptado por SUNAT
    ...
    ////Listar todas las facturas por administrador 
    ...
    case 'envioautomaticolistartodo':
        ...
        $rspta = $factura->listarTodo($idempr);
        //Vamos a declarar un array
        $data = array();
        ...
        while ($reg = $rspta->fetch_object()) {
            ...
            $data[] = array(
                ...
                "8" => ($reg->estado == '1') //si esta emitido
                    ? '<span style="color:#111c43;">' . $reg->DetalleSunat . '</span>'
                    : (($reg->estado == '4') ? '<span style="color:#239B56;">' . $reg->DetalleSunat . '</span>' //si esta firmado
    ...
    case 'listarValidar':
        ...
        $rspta = $factura->listarValidar($ano, $mes, $dia, $_SESSION['idempresa'], $idusuario);
        //Vamos a declarar un array
        $data = array();
    ...
    case 'listarDR':
        ...
        $rspta = $factura->listarDR($ano, $mes, $_SESSION['idempresa'], $idusuario);
        //Vamos a declarar un array
        $data = array();
