...
if (isset($_GET['action'])) {
  ...
  if ($action == 'listar2') {
	$rspta = $empleadobol->listar2();
	$data = array();
  
	while ($reg=$rspta->fetch_object()){
        $data[]=array(
			'idempleado' => $reg->idempleado,
            'nombresE' => $reg->nombresE,
            'apellidosE' => $reg->apellidosE
        );
    }
	$results = array(
		"aaData"=>$data
 		...
 		while ($reg=$rspta->fetch_object()){
			 ...
			 <div class="dropdown">
				 ...
				 <div class="dropdown-menu" style="">
				   ...
				   <a class="dropdown-item" onclick="eliminar('.$reg->idboletapago.')"><i class="fa fa-close" style="color:red;"></i>Eliminar</a>
				   <a class="dropdown-item" onclick="editarboleta('.$reg->idboletapago.')"><i class="fa fa-pencil" style="color:orange;"></i>Editar boleta</a>
				   <a  class="dropdown-item" onclick="previoprint('.$reg->idboletapago.')"> <i class="fa  fa-print"  data-toggle="tooltip" title="Imprimir boleta de pago" onclick=""></i>Imprimir </a>
