...
switch ($_GET["op"]) {
    ...
    case 'guardaryeditarBoleta':
        ...
        if (empty($idnotaped)) {
            ...
            if ($idcliente == "N") {
                ...
                if ($rspta) {
                    echo "Se guardó la nota de pedido correctamente";
                } else {
    ...
    case 'listar':
        ...
        $rspta = $notapedido->listar($idusuario);
        //Vamos a declarar un array
        $data = array();
    ...
    //LISTAR TODO COMO ADMINISTRADOR 

    case 'listarTodo':
        
        $rspta = $notapedido->listarTodo();
        //Vamos a declarar un array
        $data = array();
