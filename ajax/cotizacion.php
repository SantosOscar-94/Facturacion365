...
switch ($_GET["op"]) {
    case 'guardaryeditarcotizacion':
        ...
        if (empty($idcotizacion)) {
            $rspta = $cotizacion->insertar($idempresa, $idusuario, $idcliente, $serienota, $tipo_moneda, $fecha_emision, $hora, $tipocotizacion, $subtotal_producto, $impuesto, $total, $observacion, $vendedorsitio, $_POST["idarticulo"], $_POST["codigo"], $_POST["cantidad"], $_POST["precio_unitario"], $numero_cotizacion, $idserie, $_POST["descdet"], $_POST["numero_orden_item"], $fechavalidez, $tcambio, $_POST["subtotalBD"], $_POST["pvt"], $_POST["igvBD"], $_POST["igvBD2"], $nrofactura);
            $hora = date("h:i:s");
    ...
    case 'listarDetallecoti':
        ...
        <thead style="background-color:#081A51; color: #fff; text-align: center;">
                                    <th >Sup.</th>
                                    <th >Item</th>
                                    <th >Artículo</th>
                                    <th >Cantidad</th>
        ...
        <td>
        <input type="text" required="true" class="form-control" name="cantidad[]" id="cantidad[]"  onBlur="modificarSubototalesProductos()" size="2" onkeypress="return NumCheck(event, this)"  value="' . $reg->cantidad . '" focus >
        </td>
        ...
        <input type="text" name="codigo[]" id="codigo[]" value="' . $reg->codigo . '" class="form-control" size="4">
        ...
        <td>
        <input type="text" class="form-control" name="precio_unitario[]" id="precio_unitario[]" value="' . $reg->precioc . '"   onBlur="modificarSubototalesProductos()" size="5" onkeypress="return NumCheck2(event, this)" >
        </td>


        <td>
        <input type="text" class="form-control" name="valor_unitario2[]" id="valor_unitario2[]" size="5"  value="' . $reg->valorunitario . '" onBlur="modificarSubototalesProductos()">
        </td>
        ...
        echo '<tfoot style="vertical-align: center;">
                        ...
                        <tr>
                           <td><td></td><td></td><td></td><td></td><td></td><td></td>
                                    ...
                                    <th style="font-weight: bold; background:#081A51;">
                                      ...
                                      <h4 style="color:white; font-size: 14px"  id="subtotal">' . $subt . '</h4>
                           ...
                           <tr>
                            <td><td></td><td></td><td></td><td></td><td></td><td></td>
                                    ...
                                    <th  style="font-weight: bold; vertical-align: center; background:#081A51;">igv 18% </th>

                                    <th style="font-weight: bold; background:#081A51; vertical-align: center;">

                                      <h4 style="color:white; font-size: 14px" id="igv_">' . $igv . '</h4>
                        ...
                        <h4 id="total" style="font-weight: bold; vertical-align: center; color:white; font-size: 14px; background:#081A51;">' . $total . '</h4>
    ...
    case 'traerdetallenfactura':
       ...
       <tr>
            <td>
                ...
                <th style="font-weight: bold;  background-color:#081A51;">Neta: </th>
                <th style="font-weight: bold; background-color:#081A51;"> <h4 style="color:white;font-size: 14px" id="subtotalfactura">' . $subt . '</h4></th>
            ...
            <td>
                <td></td><td></td><td></td><td></td><td></td>
                <th style="font-weight: bold;  background-color:#081A51;">Igv: </th>
                <th style="font-weight: bold; background-color:#081A51;"> <h4 style="color:white;font-size: 14px" id="igvfactura">' . $igv . '</h4></th>
          ...
          <tr>
            <td>
                <td></td><td></td><td></td><td></td><td></td>
                <th style="font-weight: bold;  background-color:#081A51;">Total: </th>
                <th style="font-weight: bold; background-color:#081A51;"> <h4 style="color:white;font-size: 14px" id="totalfactura">' . $total . '</h4></th>
