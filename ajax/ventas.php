...
// }
    ...
    case 'listarventasxruc':
        ...
        while ($reg = $rspta->fetch_object()) {
            $data[] = array(
                ...
                "6" => $reg->igv,
                "7" => $reg->total,
                "8" => ($reg->estado == '1') ? '<i class="fa fa-file-text-o" style="font-size: 10px; color:#BA4A00;"><span> ENVIANDO</span></i>'
    ...
    case 'listarcomprobantes':
        ...
        $rspta = $venta->listarcomprobantes($fec1, $fec2, $tipocte, $Estd, $idusuario);
        //Vamos a declarar un array
        ...
        while ($reg = $rspta->fetch_object()) {
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" style="">
                    ...
                    <a  class="dropdown-item" onclick="mostrarxml(' . $reg->idcomprobante . ', ' . $reg->tipo_documento_07 . ')"><i class="fa fa-check" style="color:orange;" data-toggle="tooltip" title="Descargar XML"> </i> Descargar XML</a>
                    <a  class="dropdown-item" onclick="mostrarrpta(' . $reg->idcomprobante . ', ' . $reg->tipo_documento_07 . ')"><i class="fa fa-check" style="color:green; data-toggle="tooltip" title="Descargar CDR"> </i> Descargar CDR</a>
