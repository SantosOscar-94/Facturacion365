...
class PDF_Invoice extends FPDF
{
    ...
    function addSociete($telefono, $email, $direccion, $logo, $ext_logo)
    {
        ...
        //$this->Image('../public/img/marcoPDF.png', 0, 0, 210, 297);
    }
    ...
    function numBoleta($num, $ruc, $fecha)
    {
        $r1 = $this->w - 70;
        $r2 = $r1 + 60;
        $y1 = 15;
    ...
    // Client address
    function addClientAdresse($cliente, $domicilio, $num_documento, $estado, $usuario, $descripcion_leyenda_26_2, $tipopago, $nroreferencia, $moneda)
    {
        $r1 = $this->w - 200;
        $r2 = $r1 + 68;
        $y1 = 28;
        ...
        $this->MultiCell(150, 3, utf8_decode("Obs: ") . $descripcion_leyenda_26_2);
    ...
    // Client address
    function addClientAdresse2($fecha, $cliente, $domicilio, $num_documento, $estado, $usuario, $descripcion_leyenda_26_2, $tipopago, $nroreferencia)
    {
        $r1 = $this->w - 190;
        $r2 = $r1 + 68;
        $y1 = 170; // Edicion
