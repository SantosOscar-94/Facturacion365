...
<div class="tm_invoice_in">
  ...
  <div class="tm_invoice_info tm_mb10 tm_align_center">
    <div class="tm_invoice_info_left tm_mb20_md">
      <p class="tm_mb0">
        <b class="tm_primary_color">Comprobante: </b><?php echo $reg->numeracion_08; ?> <br>
          ...
          <tbody>
            <tr>
              ...
              <td class="tm_width_6 tm_border_top_0 tm_border_left tm_accent_border_20">
                <b class="tm_primary_color tm_medium">RUC: </b> <?php echo $reg->numero_documento; ?>
              </td>
            </tr>
            <tr>
          ...
          <?php
                        ...
                        while ($regd = $rsptad->fetch_object()) {
                            ...
                            if ($regd->nombretribu == "IGV") {
                                ...
                                $subt = $regd->precio_venta_item_15_2;
                            } else {
                                $pv = $regd->precio;
                                $subt = $regd->subtotal2;
        ...
        <table class="">
          ...
          <tbody>
            ...
            <?php if ($reg->sumatoria_igv_22_1 > 0): ?>
              ...
              <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0"><?php echo $reg->sumatoria_igv_22_1 ?></td>
            <?php endif; ?>
            </tr>
            <tr>
            ...
            <tr class="tm_accent_border_20 tm_border">
              ...
              <td
                ...
                <?php echo $reg->importe_total_venta_27 ?></td>
            </tr>
...
<!--              
  ...
  <div class="tm_bottom_invoice tm_accent_border_20">
    <div class="tm_bottom_invoice_left">
      ...
      <?php 
        echo "<p class='tm_primary_color tm_f12 tm_m0 tm_bold'>El comprobante " . $reg->numeracion_08 . " a sido " . $mensaje . "</p>";
      ?>
      
      <!-- <p class="tm_primary_color tm_f12 tm_m0 tm_bold">Terms & Condition</p> -->
      <!-- <p class="tm_m0 tm_f12">IInvoice was created on a computer and is valid without the signature and seal.
      </p> -->
    </div>
