    ...
    <div class="tm_container">
        <div class="tm_pos_invoice_wrap" id="tm_download_section">
            ...
            <div class="tm_pos_invoice_body">
                <div class="tm_pos_invoice_heading"><span><strong> NOTA DE PEDIDO </strong></span></div>
                ...
                <ul class="tm_list tm_style1">
                    ...
                    <li class="text-right">
                        <div class="tm_list_title">RUC/DNI:</div>
                    ...
                    <li class="text-right">
                        <div class="tm_list_title"></div>
                        <div class="tm_list_desc"> </div>
                    </li>
                    <li>
...
<?php
        if (shouldDisplayPaymentMethods($reg)) {
            echo "<div style='text-align:center;'' class='tm_pos_invoice'><span><strong> Métodos de pago </strong></span></div>";
        ...
        ?>
                ...
                <div class="tm_bill_list">
                    ...
                    <div class="tm_bill_list_in">
                        ...
                        <div class="tm_bill_value tm_bill_focus">s/ <?php echo $reg->subtotal ?></div>
                    </div>
                </div>
                <?php
                ...
                echo "Pagaste: </strong>" . $con_letra . "</div>";
                ?>
                <br>
                             
               
                <div class="tm_pos_invoice_footer"><?php echo $datose->textolibre; ?></div>
            </div>
        </div>
    ...
    <script src="files/assets/js/jspdf.min.js"></script>
    <script src="files/assets/js/html2canvas.min.js"></script> -->
    <!-- <script>
