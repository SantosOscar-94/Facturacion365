...
if (!isset($_SESSION["nombre"])) {
    ...
    if ($_SESSION['Logistica'] == 1) {
        ...
        <body onload="window.print();">
            ...
            $rspta = $modelotransferencia->ventacabecera($_GET["id"]);
            ...
            <table align="center">
                <tbody>
                    ...
                    <tr>
                        <td align="center">
                            <strong> TRANSFERENCIA DE STOCK </br>
        ...
        <td ><strong>Fecha de Vcto:</strong>
         <?php echo "."; ?></td>
            ...
            <table border="0" align="center" width="220px" style="font-size: 12px">
                ...
                $rsptad = $modelotransferencia->ventadetalle($_GET["id"]);
                $cantidad = 0;
    ...
    <tr><td>-----------------------------------------------------</td></tr>";
            ...
            <td>" . $reg->faltante . "</td>
                ...
                <tr>
                    <td colspan="5" align="center">::.TRANSFERENCIA EXITOSA.::</td>
                </tr>
