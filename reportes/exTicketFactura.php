...
if (!isset($_SESSION["nombre"])) {
    ...
    <div class="tm_container">
        <div class="tm_pos_invoice_wrap" id="tm_download_section">
            ...
            <div class="tm_pos_invoice_heading"><span><strong> FACTURA DE VENTA ELECTRÓNICA </strong></span></div>
                <div class="tm_pos_invoice_heading"><span><strong> <?php echo $reg->numeracion_08; ?> </strong></span></div>
                <ul class="tm_list tm_style1">
                    <div class="rucdesing">
                    <div><label for="">Cliente: <?php echo $reg->cliente; ?></label></div>
                    <div><label for="">RUC: <?php echo $reg->numero_documento; ?></label></div>
                    <div><label for="">Dirección: <?php echo utf8_decode(strtoupper($reg->direccion)); ?></label></div>
                   
                    </div>

                    <li>
                        <div class="tm_list_title">Fecha E:</div>
                        <div class="tm_list_desc"> <?php echo $reg->fecha; ?></div>
                    </li>

                    <li class="text-right">
                        <div class="tm_list_title">Fecha V:</div>
                        <div class="tm_list_desc">  <?php echo $reg->fechavenc; ?></div>
                    </li>
                    ...
                    <li class="text-right">
                        ...
                        <div class="tm_list_desc"> <?php echo $reg->moneda; ?></div>
                    </li>
        ...
        ?>
                    ...
                    <?php
                        ...
                        while ($regd = $rsptad->fetch_object()) {
                            ...
                            if ($regd->nombretribu == "IGV") {
                                $pv = $regd->precio_venta_item_15_2;
                                $subt = $regd->subtotal;
                            } else {
                                $pv = $regd->precio;
                                $subt = $regd->subtotal2;
                ...
                <div class="tm_bill_list">
                    ...
                    <div class="tm_bill_list_in">
                        <?php if ($reg->sumatoria_igv_22_1 > 0): ?>
                            <div class="tm_bill_title">I.G.V.:</div>
                            <div class="tm_bill_value"><?php echo $reg->sumatoria_igv_22_1 ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="tm_bill_list_in">
                        <?php if ($reg->importe_total_venta_27 > 0): ?>
                            <div class="tm_bill_title tm_bill_focus">Total a pagar:</div>
                            <div class="tm_bill_value tm_bill_focus"><?php echo $reg->importe_total_venta_27 ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php
                        ...
                        <div style="text-align: center;">
                            ...
                            <br>
                            <br>
                            <label style="font-size:9px;">Representación impresa de la Factura de <br>Venta Electrónica puede ser consultada<br>en
