                ...
                if ($_SESSION['Logistica'] == 1) {
                    ...
                    echo '<li class="slide__category"><span class="category-name">Logística</span></li>
                        ...
                        <li class="slide has-sub">
                            ...
                            <li class="slide">
                               <a href="transferencia" class="side-menu__item">
                                   <i class="bx bx-folder-open side-menu__icon"></i>
                                   <span class="side-menu__label">Transferencia stock</span>
                               </a>
                            </li> 
                ...
                if ($_SESSION['Ventas'] == 1) {
                    echo '<li class="slide__category"><span class="category-name">Gestión de Ventas</span></li>
                            ...
                            <a href="pos" class="side-menu__item">
                                ...
                                <span class="side-menu__label">Punto de venta</span>
                            </a>
                            </li>
                            ...
                            <a href="javascript:void(0);" class="side-menu__item">
                                ...
                                <span class="side-menu__label">Lista de ventas</span>
                                <i class="fe fe-chevron-right side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide side-menu__label1">
                            ...
                            <li class="slide">
                            <a href="guiaremision" class="side-menu__item">
                                <i class="bx bx-blanket side-menu__icon"></i>
                                <span class="side-menu__label">Guía de remisión</span>
                            </a>
                            </li>

                            <li class="slide">
                            <a href="cotizacion" class="side-menu__item">
                ...
                if ($_SESSION['RRHH'] == 1) {
                    echo '<li class="slide__category"><span class="category-name">Gestión RRHH</span></li> 
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                <a href="vendedorsitio" class="side-menu__item">Lista de vendedores</a>
                            </li>
