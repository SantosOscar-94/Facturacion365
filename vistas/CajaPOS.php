...
if (!isset($_SESSION["nombre"])) {
  ...
  require '../vistas/template/partials/hpos.php';
    ...
    <style>
      body{
        ...
        <div class="content-header">
          <h1> <button class="btn btn-success" data-bs-toggle="modal"
  ...
  require '../vistas/template/partials/fpos.php';
  ?>
    <script type="text/javascript" src="scripts/scripModalPOS.js"></script>
