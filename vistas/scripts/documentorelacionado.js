        ...
        tabla = $('#tbllistadoDR').dataTable(
            {
                ...
                "ajax":
                {
                    url: '../ajax/factura.php?op=listarDR&ano=' + $ano + '&mes=' + $mes + '&idempresa=' + $idempresa + "&idusuario=" + sessionStorage.getItem("idusuario"),
                    type: "get",
                    dataType: "json",
                    error: function (e) {
        ...
        tabla = $('#tbllistadoDR').dataTable(
            {
                ...
                "ajax":
                {
                    url: '../ajax/boleta.php?op=listarDR&ano=' + $ano + '&mes=' + $mes + '&idempresa=' + $idempresa + "&idusuario=" + sessionStorage.getItem("idusuario"),
                    type: "get",
                    dataType: "json",
                    error: function (e) {
                        console.log(e.responseText);
