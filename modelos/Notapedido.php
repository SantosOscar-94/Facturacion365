...
Class Notapedido
{
    ...
    public function __construct()
    {
     ...
     //Implementamos un método para insertar registros para notapedido
     public function traeridsaldoininotaped($idusuario){
