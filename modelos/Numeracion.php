...
class Numeracion
{
    ...
    public function llenarSerieNtransferenciastock($idusuario)
    {
        $sql = "select n.idnumeracion, n.serie from numeracion n inner join detalle_usuario_numeracion dn on n.idnumeracion=dn.idnumeracion inner join usuario u on dn.idusuario=u.idusuario where n.tipo_documento='14' and dn.idusuario='$idusuario' group by n.serie";
        return ejecutarConsulta($sql);    // Las series van deacuerdo a las asginaciones que e le de en los permisos de usuario       
    }
    ...
    public function llenarNumeroNtransferenciastock($serie)
    {
        $sql = "select (n.numero+1) as Nnumero from numeracion n inner join detalle_usuario_numeracion dn on n.idnumeracion=dn.idnumeracion inner join usuario u on dn.idusuario=u.idusuario where n.tipo_documento='14' and n.idnumeracion='$serie' limit 1";
        return ejecutarConsulta($sql);  // Las series van deacuerdo a las asginaciones que e le de en los permisos de usuario     
    }
